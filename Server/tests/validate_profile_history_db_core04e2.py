...
try:
    ...
    checks.append(
        ck(
            "Canonical buckets equal total executions",
            total_from_states
    ...
    checks.append(
        ck(
            "No invalid execution_state values",
    ...
    if latest:
        checks.append(
            ck(
                "Latest execution has publicId",
                bool(latest["public_id"]),
            )
        )
        checks.append(
            ck(
                "Latest execution has codename",
                bool(latest["codename"]),
            )
        )
        checks.append(
            ck(
                "Latest execution has submission title",
                bool(latest["submission_title"]),
            )
        )
        checks.append(
            ck(
                "Latest execution has canonical state",
